...
ArCF4.plotTeoCurve("vis",cmap=plt.get_cmap("inferno"), savefig="Ajuste_VIS_GlobalNorm.pdf")
ArCF4.plotTeoCurve("uv",cmap=plt.get_cmap("inferno"),  savefig="Ajuste_UV_GlobalNorm.pdf")
...
param_labels = ["N", "P1", "P2", "P3", "K3", "K4", "K5"]
