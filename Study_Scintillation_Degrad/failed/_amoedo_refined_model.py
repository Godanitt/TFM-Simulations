...
def Pgamma_CF3_refined(f_cf4, Pgamma_CF3_star_dir, P_Ar_dblstar,autoQ):
    ...
    return f_cf4 * Pgamma_CF3_star_dir*(1-autoQ) + (1 - f_cf4) * P_Ar_dblstar * frac


def Pgamma_CF4_refined(f_cf4, Pgamma_CF4_plus_star_dir, P_Ar_3rd, n,kcool):
    ...
    return f_cf4 * Pgamma_CF4_plus_star_dir * relajacion + (1 - f_cf4) * P_Ar_3rd * frac
