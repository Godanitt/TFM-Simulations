...
garfield = read_garfield_csv_folder(
    ...
    output_general_name="../data/Secondary_GarfieldData/ArN2/populations/ArN2_IR_secondary",
...
for i,electric_field in enumerate(electric_fields):
    ...
    yield_teo = theory_yield_ArN2_Ir_696(parameter_data, garfield_data, fN2, pressure)   / 10000 / 100 * (W_ArN2(fN2)) / 0.2
    yield_teo += theory_yield_ArN2_Ir_727(parameter_data, garfield_data, fN2, pressure)  / 10000 / 100  * (W_ArN2(fN2)) / 0.2
    yield_teo += theory_yield_ArN2_Ir_750(parameter_data, garfield_data, fN2, pressure)  / 10000 / 100  * (W_ArN2(fN2)) / 0.2
    yield_teo += theory_yield_ArN2_Ir_763(parameter_data, garfield_data, fN2, pressure)  / 10000 / 100  * (W_ArN2(fN2)) / 0.2
    yield_teo += theory_yield_ArN2_Ir_772(parameter_data, garfield_data, fN2, pressure)  / 10000 / 100  * (W_ArN2(fN2)) / 0.2
...
plt.legend()
plt.savefig("plots/ArN2_IR_secondary.pdf")
