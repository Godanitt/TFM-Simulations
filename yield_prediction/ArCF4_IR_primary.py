...
for i in range(len(pressure)):
    ...
    yield_teo = theory_yield_ArCF4_Ir_696(parameter_data, degrad_data, fN2, pressure[i]) / 0.015 * (W_ArCF4(fN2)) / Norm
    yield_teo += theory_yield_ArCF4_Ir_727(parameter_data, degrad_data, fN2, pressure[i]) / 0.015 * (W_ArCF4(fN2)) / Norm
    yield_teo += theory_yield_ArCF4_Ir_750(parameter_data, degrad_data, fN2, pressure[i]) / 0.015 * (W_ArCF4(fN2)) / Norm
    yield_teo += theory_yield_ArCF4_Ir_763(parameter_data, degrad_data, fN2, pressure[i]) / 0.015 * (W_ArCF4(fN2)) / Norm
    yield_teo += theory_yield_ArCF4_Ir_772(parameter_data, degrad_data, fN2, pressure[i]) / 0.015 * (W_ArCF4(fN2)) / Norm
    yield_teo += theory_yield_ArCF4_Ir_794(parameter_data, degrad_data, fN2, pressure[i]) / 0.015 * (W_ArCF4(fN2)) / Norm
