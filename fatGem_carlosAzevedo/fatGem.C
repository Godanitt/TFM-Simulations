...
int main (int argc, char *argv[]){
	...
	if (argc<5){
		...
		cout<<"./fatGem fieldMapFolder rootFileName.root pressure(bar) pitch(mm)"<<endl;
		exit(EXIT_FAILURE);
	...
	std::strcpy (gasstr, "Xe");

	int npe = 1;//number of primary electrons
	...
	int nBinsChrg = 400;#include <iostream>
